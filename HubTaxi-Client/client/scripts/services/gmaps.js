        ...
        function ($rootScope, $timeout, $logger, config, taxi, $state, $window, appConfig, $filter) {
            ...
            var gMaps = {
                ...
                init: function () {
                    ...
                    gMaps.map = L.map('map').setView([-34.760393, -58.359404], 15);

                    /*L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
                     {    maxZoom: 18  }).addTo(gMaps.map);*/

                    L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/streets-v12/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoieGNoYXZlengiLCJhIjoiY2xkamgwYTZ3MWRwbzN1bnVqMXhucXBqOSJ9.Q12JNdO0dxozFfggxzc4bA',
